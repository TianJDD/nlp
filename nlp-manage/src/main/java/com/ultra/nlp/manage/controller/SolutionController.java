...
public class SolutionController {
    ...
    public Object addSolution(HttpServletRequest request, HttpServletResponse response,
        ...
        try{
            ...
            nlpSolution.setId(StringUtil.getUUID());
     ...
     * @auther: guyuefei
     * @date:
     * 2018年5月30日15:00:24 modified by jit，添加groupId和professorId
     */
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "groupId", value = "解决方案团队", required = false, dataType = "String"),
            @ApiImplicitParam(name = "professorId", value = "解决方案教授", required = false, dataType = "String")
    })
    @ApiResponse(code = 0000,message = "成功",response = JsonModel.class)
    ...
    public Object updateSolution(HttpServletRequest request, HttpServletResponse response,
                                 ...
                                 @RequestParam(value = "isCharge",required = false)String isCharge
    ){
        try{
